...
class LoginScreem: UIView {
    ...
    lazy var recoverPasswordButton: UIButton = {
        ...
        button.setTitleColor(UIColor(red: 321/255, green: 48/255, blue: 214/255, alpha: 1.0), for: .normal)
    ...
    private func configConstraints(){
        NSLayoutConstraint.activate([
            ...
            signInMetaMaskImageView.leadingAnchor.constraint(equalTo: signInMetaMaskView.leadingAnchor, constant: 73),
